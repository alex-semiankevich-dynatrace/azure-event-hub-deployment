...
| File | Description |
|------|-------------|
| `armTemplate.jsons` | ARM template (subscription-level) that deploys resource groups, Event Hub namespaces, Event Hubs, and RBAC role assignments |
...
az deployment sub create \
  --location eastus \
  --template-file armTemplate.jsons \
